...
void main() {
  group('HivePixelArtRepository', () {
    ...
    test('create and read a PixelArt', () async {
      ...
      final createdPixelArt = testPixelArt.copyWith(name: 'Created Name');
      final createResult =
          await repository.create(createdPixelArt);
      expect(createResult.isSuccess, true);
      expect(createResult.value?.name, 'Created Name');
    });
    ...
    test('list all PixelArts', () async {
      ...
      final listAllResult = await repository.list();
      expect(listAllResult.isSuccess, true);
      expect(listAllResult, greaterThanOrEqualTo(0));
    });
  ...
  group('PixelArt API', () {
    ...
    test('POST / - creates a PixelArt', () async {
      ...
      final source = await response.body();
    ...
    test('GET / - lists all PixelArts', () async {
      ...
      List<PixelArt> items = body.map((e) => PixelArt.deserialize(e as String)).toList();
